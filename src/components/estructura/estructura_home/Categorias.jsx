...
const Categorias = () => {
  ...
  const { filtrarPorCategoria } = useDatosAnuncio();
      ...
      <div className="contenedor-categorias-home">
        <div className="categoria-home c-1">
          <img
            onClick={() => {
              navegar("/Explora");
              filtrarPorCategoria("Artes Gráficas");
            }}
            loading="lazy"
        ...
        <div className="categoria-home c-2">
          <img
            onClick={() => {
              navegar("/Explora");
              filtrarPorCategoria("Markting Digital");
            }}
            loading="lazy"
        ...
        <div className="categoria-home c-3">
          <img
            onClick={() => {
              navegar("/Explora");
              filtrarPorCategoria("Escritura y Traducción");
            }}
            loading="lazy"
        ...
        <div className="categoria-home c-4">
          <img
            onClick={() => {
              navegar("/Explora");
              filtrarPorCategoria("Video y Animación");
            }}
            loading="lazy"
        ...
        <div className="categoria-home c-5">
          <img
            onClick={() => {
              navegar("/Explora");
              filtrarPorCategoria("Música y Audio");
            }}
            loading="lazy"
        ...
        <div className="categoria-home c-6">
          <img
            onClick={() => {
              navegar("/Explora");
              filtrarPorCategoria("Programación y Tecnología");
            }}
            loading="lazy"
